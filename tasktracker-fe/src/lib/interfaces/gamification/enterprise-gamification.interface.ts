/*
 * Enterprise Gamification Interfaces - Moved from lib/types/enterprise-gamification.ts for .cursorrules compliance
 * lib/interfaces/gamification/enterprise-gamification.interface.ts
