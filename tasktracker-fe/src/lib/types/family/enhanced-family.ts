 ...
 * All rights reserved.
 *
 * Enhanced Family Management Types
 * Comprehensive family management system with advanced privacy controls
 */

import { FamilyRoleDTO, FamilyMemberDTO, FamilyRelationshipType } from './family-invitation';
import { FamilyMemberAgeGroup } from '../auth/auth';

// === ENHANCED INVITATION SYSTEM TYPES ===
...
// === ADVANCED ROLE ASSIGNMENT TYPES ===
...
// === FAMILY PRIVACY DASHBOARD TYPES ===
...
// Component props moved to @/lib/props/components/family.props.ts for .cursorrules compliance

// Supporting data types remain here as they are not component props
