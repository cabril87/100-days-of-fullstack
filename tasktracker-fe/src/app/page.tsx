...
export default function Home() {
  return (
    <div className="min-h-screen">
          ...
          <div className="relative mx-auto max-w-4xl h-[400px] mb-16">
            <div className="apple-card absolute top-0 left-0 w-full h-full overflow-hidden flex items-center justify-center">
              <div className="relative w-full h-full">
                <div className="absolute inset-0 bg-gradient-to-br from-brand-navy-dark/20 to-brand-navy/20 z-0"></div>
                <div className="relative z-10 p-8 flex flex-col items-center justify-center h-full">
                  ...
                  <div className="flex gap-4">
                    <Link 
                      href="/auth/register"
                      className="px-8 py-4 bg-brand-navy text-white rounded-full hover:bg-opacity-90 transition-all font-medium text-lg"
                    >
                      Get Started
                    </Link>
                    <Link 
                      href="/auth/login"
                      className="px-8 py-4 bg-white bg-opacity-50 backdrop-blur-sm text-gray-800 rounded-full hover:bg-opacity-70 transition-all font-medium text-lg border border-white/30"
                    >
                      Sign In
                    </Link>
                  </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white bg-opacity-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="apple-card flex flex-col items-center text-center">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="apple-card bg-gradient-to-br from-brand-cream to-white dark:from-navy to-navy-dark">
            <div className="text-center">
              <h2 className="text-3xl font-semibold mb-12">Why people love TaskTracker</h2>
              
              <div className="flex flex-col md:flex-row gap-8 justify-center">
                <div className="bg-white bg-opacity-70 backdrop-blur-sm p-6 rounded-2xl shadow-sm flex-1 max-w-md dark:bg-white/10">
      ...
      {/* Call to Action */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-brand-navy/10 to-brand-beige/10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link 
              href="/dashboard"
              className="px-8 py-4 bg-white bg-opacity-60 backdrop-blur-sm text-gray-800 rounded-full hover:bg-opacity-80 transition-all font-medium text-lg border border-white/30 dark:text-gray-100 dark:bg-white/10"
            >
              View Demo
            </Link>
          </div>
