...
public class FamilyAchievementsController : ControllerBase
{
    ...
    public async Task<ActionResult<IEnumerable<FamilyAchievementDTO>>> GetAchievementsByFamilyId(int familyId)
    {
        try
        {
            ...
            var achievements = await _achievementService.GetByFamilyIdAsync(familyId, userId);
            return Ok(achievements);
        }
    ...
    public async Task<ActionResult<IEnumerable<FamilyAchievementDTO>>> GetCompletedAchievementsByFamilyId(int familyId)
    {
        ...
        {
            int userId = User.GetUserId();
            var achievements = await _achievementService.GetCompletedByFamilyIdAsync(familyId, userId);
            return Ok(achievements);
        }
        catch (UnauthorizedAccessException ex)
        {
    ...
    public async Task<ActionResult<IEnumerable<FamilyAchievementDTO>>> GetInProgressAchievementsByFamilyId(int familyId)
    {
        ...
        {
            int userId = User.GetUserId();
            var achievements = await _achievementService.GetInProgressByFamilyIdAsync(familyId, userId);
            return Ok(achievements);
        }
        catch (UnauthorizedAccessException ex)
        {
    ...
    public async Task<ActionResult<FamilyAchievementDTO>> CreateAchievement([FromBody] FamilyAchievementCreateDTO achievementDto)
    {
        ...
        {
            int userId = User.GetUserId();
            var achievement = await _achievementService.CreateAsync(achievementDto, userId);
    ...
    public async Task<ActionResult<FamilyAchievementDTO>> UpdateAchievement(int id, [FromBody] FamilyAchievementUpdateDTO achievementDto)
    {
        ...
        {
            int userId = User.GetUserId();
            var achievement = await _achievementService.UpdateAsync(id, achievementDto, userId);
    ...
    public async Task<ActionResult> DeleteAchievement(int id)
    {
        ...
        {
            int userId = User.GetUserId();
            var result = await _achievementService.DeleteAsync(id, userId);
    ...
    public async Task<ActionResult> UpdateProgress(int id, [FromBody] ProgressUpdateDTO progressDto)
    {
        ...
        {
            int userId = User.GetUserId();
            var result = await _achievementService.UpdateProgressAsync(
                id, 
                progressDto.ProgressIncrease, 
                progressDto.MemberId, 
                userId
            );
        ...
        {
            _logger.LogError(ex, "Error updating progress for family achievement {AchievementId}", id);
    ...
    public async Task<ActionResult<IEnumerable<FamilyLeaderboardDTO>>> GetLeaderboard([FromQuery] int limit = 10)
    {
        try
        {
            var leaderboard = await _achievementService.GetLeaderboardAsync(limit);
            return Ok(leaderboard);
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "Error retrieving family leaderboard");
            return StatusCode(500, "An error occurred while retrieving the family leaderboard");
        }
    }
    ...
    public async Task<ActionResult<FamilyLeaderboardDTO>> GetFamilyStats(int familyId)
    {
        ...
        {
            int userId = User.GetUserId();
            var stats = await _achievementService.GetFamilyStatsAsync(familyId, userId);
        ...
        {
            _logger.LogError(ex, "Error retrieving stats for family {FamilyId}", familyId);
            return StatusCode(500, "An error occurred while retrieving family stats");
        }
    }
    ...
    public async Task<ActionResult> TrackTaskCompletion(int taskId, [FromBody] TaskCompletionDTO completionDto)
    {
        ...
        {
            int userId = User.GetUserId();
            var result = await _achievementService.TrackTaskCompletionAsync(
                taskId, 
                completionDto.MemberId, 
                userId
            );
