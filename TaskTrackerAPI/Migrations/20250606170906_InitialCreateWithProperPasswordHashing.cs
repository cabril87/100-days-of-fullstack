    ...
    public partial class InitialCreateWithProperPasswordHashing : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "BackgroundServiceExecutions",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ServiceName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ExecutionTime = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BackgroundServiceExecutions", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "BackgroundServiceStatuses",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BackgroundServiceStatuses", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "SystemMaintenanceNotifications",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    AffectedServices = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true, defaultValue: new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified))
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SystemMaintenanceNotifications", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "SystemOptimizationRecommendations",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    ImplementationNotes = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SystemOptimizationRecommendations", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SuccessRateBefore = table.Column<double>(type: "float", nullable: true),
                    SuccessRateAfter = table.Column<double>(type: "float", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaskLimit = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BoardId = table.Column<int>(type: "int", nullable: false),
                    EnableWipLimits = table.Column<bool>(type: "bit", nullable: false),
                    ShowSubtasks = table.Column<bool>(type: "bit", nullable: false),
                    EnableSwimLanes = table.Column<bool>(type: "bit", nullable: false),
                    DefaultTaskView = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    EnableDragDrop = table.Column<bool>(type: "bit", nullable: false),
                    ShowTaskIds = table.Column<bool>(type: "bit", nullable: false),
                    EnableTaskTimer = table.Column<bool>(type: "bit", nullable: false),
                    ShowProgressBars = table.Column<bool>(type: "bit", nullable: false),
                    ShowAvatars = table.Column<bool>(type: "bit", nullable: false),
                    ShowDueDates = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    EnableRealTimeCollaboration = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    CustomThemeConfig = table.Column<string>(type: "ntext", nullable: true),
                    SwimLaneGroupBy = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    DefaultSortBy = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    DefaultSortDirection = table.Column<string>(type: "nvarchar(4)", maxLength: 4, nullable: false),
                    ShowColumnCounts = table.Column<bool>(type: "bit", nullable: false),
                    ShowBoardStats = table.Column<bool>(type: "bit", nullable: false),
                    EnableGamification = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BoardSettings_Boards_BoardId",
                        column: x => x.BoardId,
            ...
            migrationBuilder.CreateTable(
                name: "BoardTemplateColumns",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BoardTemplateId = table.Column<int>(type: "int", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Order = table.Column<int>(type: "int", nullable: false),
                    Color = table.Column<string>(type: "nvarchar(7)", maxLength: 7, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BoardTemplateColumns", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LayoutConfiguration = table.Column<string>(type: "ntext", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AutomationRules = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    ...
                    ValueProposition = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    SuccessStories = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    ...
                    AverageCompletionTimeMinutes = table.Column<int>(type: "int", nullable: false),
                    LastUsedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    WorkflowSteps = table.Column<string>(type: "nvarchar(max)", maxLength: 5000, nullable: true),
                    ConditionalLogic = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskTemplates_TemplateCategories_TemplateCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    PreferredComplexity = table.Column<int>(type: "int", nullable: false),
                    ...
                    LearningVelocity = table.Column<double>(type: "float", nullable: false),
                    SuccessPattern = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ProcrastinationTendency = table.Column<double>(type: "float", nullable: false),
                    FocusPattern = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UsageFrequencyPattern = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MotivationFactors = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ChallengeAcceptanceRate = table.Column<double>(type: "float", nullable: false),
                    AutomationPreference = table.Column<double>(type: "float", nullable: false),
                    SocialPreference = table.Column<double>(type: "float", nullable: false),
                    LastAdaptationDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)),
                    AdaptationConfidence = table.Column<double>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserLearningProfiles_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScoringFactors = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UserFeedback = table.Column<int>(type: "int", nullable: true),
                    WasUsed = table.Column<bool>(type: "bit", nullable: false),
                    SatisfactionRating = table.Column<int>(type: "int", nullable: true),
                    AlgorithmVersion = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RecommendationContext = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WasShown = table.Column<bool>(type: "bit", nullable: false),
                    ShownAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RecommendationScores_TaskTemplates_TemplateId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Actions = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskAutomationRules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TaskAutomationRules_TaskTemplates_TemplateId",
                        column: x => x.TemplateId,
                        principalTable: "TaskTemplates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublishedDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)),
                    Description = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    Tags = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    IsFeatured = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    MinimumRating = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TemplateMarketplace", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TemplateMarketplace_TaskTemplates_TemplateId",
                        column: x => x.TemplateId,
                        principalTable: "TaskTemplates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TemplateMarketplace_Users_ApproverId",
                        column: x => x.ApproverId,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TemplateMarketplace_Users_CreatorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TemplatePurchases", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TemplatePurchases_TaskTemplates_TemplateId",
                        column: x => x.TemplateId,
                        principalTable: "TaskTemplates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TemplatePurchases_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TemplateId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    UsedDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)),
                    CompletionTimeMinutes = table.Column<int>(type: "int", nullable: false),
                    Success = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TemplateUsageAnalytics", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TemplateUsageAnalytics_TaskTemplates_TemplateId",
                        column: x => x.TemplateId,
                        principalTable: "TaskTemplates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TemplateUsageAnalytics_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkflowSteps_TaskTemplates_TemplateId",
                        column: x => x.TemplateId,
                        principalTable: "TaskTemplates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PointTransactions_TaskTemplates_TemplateId",
                        column: x => x.TemplateId,
                        principalTable: "TaskTemplates",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "General", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Simple three-column board for basic task management", true, true, "{\"theme\":\"default\",\"layout\":\"standard\"}", "Basic Kanban", null, 0, "kanban,basic,simple", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 0 },
                    { 2, 4.5m, "Development", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Agile development board with bug tracking and code review columns", true, true, "{\"theme\":\"developer\",\"layout\":\"extended\"}", "Software Development", null, 12, "agile,development,software,scrum", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 0 },
                    { 3, 4.2m, "Creative", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Board designed for content creators with ideation, writing, and publishing phases", true, true, "{\"theme\":\"creative\",\"layout\":\"workflow\"}", "Content Creation", null, 8, "content,writing,marketing,creative", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 0 },
                    { 4, 4.7m, "Business", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Comprehensive project management board with detailed workflow stages", true, true, "{\"theme\":\"professional\",\"layout\":\"detailed\"}", "Project Management", null, 15, "project,management,business,workflow", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 0 },
                    { 5, 4.0m, "Personal", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Simple personal productivity board for daily task management", true, true, "{\"theme\":\"minimal\",\"layout\":\"simple\"}", "Personal Tasks", null, 5, "personal,productivity,daily,tasks", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 0 },
                    { 6, 4.3m, "Marketing", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Track marketing campaigns from ideation to launch and analysis", false, true, "{\"theme\":\"marketing\",\"layout\":\"campaign\"}", "Marketing Campaign", null, 7, "marketing,campaign,social,advertising", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 0 },
                    { 7, 4.6m, "Development", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Dedicated board for tracking and resolving software bugs", false, true, "{\"theme\":\"bug-tracker\",\"layout\":\"priority\"}", "Bug Tracking", null, 11, "bugs,testing,qa,development", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 0 },
                    { 8, 4.1m, "Events", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Organize events from initial planning to post-event follow-up", false, true, "{\"theme\":\"events\",\"layout\":\"timeline\"}", "Event Planning", null, 6, "events,planning,coordination,logistics", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 0 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "#6B7280", "Tasks that need to be started", "clipboard", true, false, 3, "To Do", 1, null },
                    { 2, 1, "#3B82F6", "Tasks currently being worked on", "play", true, false, 1, "In Progress", 2, 3 },
                    { 3, 1, "#10B981", "Completed tasks", "check", true, true, 4, "Done", 3, null },
                    { 4, 2, "#6B7280", "Feature requests and bug reports", "list", true, false, 3, "Backlog", 1, null },
                    { 5, 2, "#F59E0B", "Features being coded", "code", true, false, 1, "In Development", 2, 2 },
                    { 6, 2, "#8B5CF6", "Code awaiting review", "eye", true, false, 1, "Code Review", 3, 3 },
                    { 7, 2, "#EF4444", "Features being tested", "bug", true, false, 1, "Testing", 4, 2 },
                    { 8, 2, "#06B6D4", "Ready for deployment", "upload", true, false, 1, "Deployment", 5, 1 },
                    { 9, 2, "#10B981", "Completed and deployed", "check", true, true, 4, "Done", 6, null },
                    { 10, 3, "#F59E0B", "Content ideas and concepts", "lightbulb", true, false, 3, "Ideas", 1, null },
                    { 11, 3, "#3B82F6", "Researching and gathering information", "search", true, false, 1, "Research", 2, 2 },
                    { 12, 3, "#8B5CF6", "Content being written", "edit", true, false, 1, "Writing", 3, 3 },
                    { 13, 3, "#EF4444", "Content under review", "eye", true, false, 1, "Review", 4, 2 },
                    { 14, 3, "#10B981", "Published content", "globe", true, true, 4, "Published", 5, null },
                    { 15, 4, "#6B7280", "Project planning and requirements", "calendar", true, false, 3, "Planning", 1, null },
                    { 16, 4, "#3B82F6", "Tasks being executed", "play", true, false, 1, "In Progress", 2, 5 },
                    { 17, 4, "#F59E0B", "Work under review", "eye", true, false, 1, "Review", 3, 3 },
                    { 18, 4, "#EF4444", "Quality assurance and testing", "shield", true, false, 1, "Testing", 4, 2 },
                    { 19, 4, "#06B6D4", "Approved and ready for deployment", "checkmark", true, false, 1, "Approved", 5, 1 },
                    { 20, 4, "#10B981", "Project milestones completed", "trophy", true, true, 4, "Completed", 6, null },
                    { 21, 5, "#EF4444", "Tasks for today", "calendar", true, false, 3, "Today", 1, 5 },
                    { 22, 5, "#F59E0B", "Tasks for this week", "clock", true, false, 1, "This Week", 2, null },
                    { 23, 5, "#10B981", "Finished tasks", "check", true, true, 4, "Completed", 3, null },
                    { 24, 6, "#F59E0B", "Campaign ideas and brainstorming", "lightbulb", true, false, 3, "Ideation", 1, null },
                    { 25, 6, "#3B82F6", "Campaign planning and strategy", "calendar", true, false, 1, "Planning", 2, 3 },
                    { 26, 6, "#8B5CF6", "Creating campaign assets", "edit", true, false, 1, "Creation", 3, 4 },
                    { 27, 6, "#EF4444", "Campaign execution and launch", "rocket", true, false, 1, "Launch", 4, 2 },
                    { 28, 6, "#10B981", "Campaign analysis and reporting", "chart", true, true, 4, "Analysis", 5, null },
                    { 29, 7, "#EF4444", "Newly reported bugs", "bug", true, false, 3, "Reported", 1, null },
                    { 30, 7, "#F59E0B", "Bugs being investigated", "search", true, false, 1, "Investigating", 2, 3 },
                    { 31, 7, "#3B82F6", "Bugs being fixed", "wrench", true, false, 1, "Fixing", 3, 2 },
                    { 32, 7, "#8B5CF6", "Fixes being tested", "shield", true, false, 1, "Testing", 4, 3 },
                    { 33, 7, "#10B981", "Fixed and verified bugs", "check", true, true, 4, "Resolved", 5, null },
                    { 34, 8, "#F59E0B", "Event concept and initial planning", "lightbulb", true, false, 3, "Concept", 1, null },
                    { 35, 8, "#3B82F6", "Detailed event planning", "calendar", true, false, 1, "Planning", 2, 5 },
                    { 36, 8, "#8B5CF6", "Event preparation and setup", "settings", true, false, 1, "Preparation", 3, 4 },
                    { 37, 8, "#EF4444", "Event day execution", "play", true, false, 1, "Execution", 4, 3 },
                    { 38, 8, "#06B6D4", "Post-event follow-up tasks", "mail", true, false, 1, "Follow-up", 5, 2 },
                    { 39, 8, "#10B981", "Event fully completed", "trophy", true, true, 4, "Completed", 6, null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BoardSettings_BoardId",
                table: "BoardSettings",
                column: "BoardId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BoardTemplateColumns_BoardTemplateId",
                table: "BoardTemplateColumns",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PointTransactions_TemplateId",
                table: "PointTransactions",
                column: "TemplateId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecommendationScores_TemplateId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskAutomationRules_TemplateId",
                table: "TaskAutomationRules",
                column: "TemplateId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskTemplates_TemplateCategoryId",
                table: "TaskTemplates",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TemplateMarketplace_ApproverId",
                table: "TemplateMarketplace",
                column: "ApproverId");

            migrationBuilder.CreateIndex(
                name: "IX_TemplateMarketplace_CreatorId",
                table: "TemplateMarketplace",
                column: "CreatorId");

            migrationBuilder.CreateIndex(
                name: "IX_TemplateMarketplace_TemplateId",
                table: "TemplateMarketplace",
                column: "TemplateId");

            migrationBuilder.CreateIndex(
                name: "IX_TemplatePurchases_TemplateId",
                table: "TemplatePurchases",
                column: "TemplateId");

            migrationBuilder.CreateIndex(
                name: "IX_TemplatePurchases_UserId",
                table: "TemplatePurchases",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_TemplateUsageAnalytics_TemplateId",
                table: "TemplateUsageAnalytics",
                column: "TemplateId");

            migrationBuilder.CreateIndex(
                name: "IX_TemplateUsageAnalytics_UserId",
                table: "TemplateUsageAnalytics",
                column: "UserId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_BoardTemplateColumns_BoardTemplates_BoardTemplateId",
                table: "BoardTemplateColumns",
                column: "BoardTemplateId",
